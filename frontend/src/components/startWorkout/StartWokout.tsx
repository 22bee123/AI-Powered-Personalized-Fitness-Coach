...
//   const [exerciseTimerInterval, setExerciseTimerInterval] = useState<NodeJS.Timeout | null>(null);
...
//     try {
//       const response = await api.put('/start-workout/exercise', {
...
//     try {
//       const response = await api.put('/start-workout/warmup-cooldown', {
//         workoutId: activeWorkout._id,
//         ...payload
//       });
...
//     try {
//       const response = await api.put(`/start-workout/complete/${activeWorkout._id}`);
